...
if ( ! function_exists( 'foundationpress_scripts' ) ) :
	function foundationpress_scripts() {
		...
		// wp_enqueue_style( 'slick-stylesheet', get_template_directory_uri() . '/dist/assets/slick/slick.css', array(), '', 'all' );
		// wp_enqueue_style( 'slick-theme', get_template_directory_uri() . '/dist/assets/slick/slick-theme.css', array(), '', 'all' );
		...
		wp_enqueue_script( 'slick-js', get_template_directory_uri() . '/dist/assets/slick/slick.min.js', array( 'jquery' ), '', true );
